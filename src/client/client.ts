 ...
 * Infer client type
 */
export type InferClient<T extends BaseQuark> = UnionToIntersection<InferRoutes<T['routes']>>;
...
export class Client implements ProtoSchema {
    /**
     * Base URL
     */
    readonly url: string;
...
export type ClientType<T extends BaseQuark> = InferClient<T> & Client;